...
describe User do
	before do
		@user = User.new(name: "example user", email: "user@example.com", 									password: "drowssap", password_confirmation: "drowssap")
	end
	...
	describe "when password_confirm is nil" do
	...
	describe "email with mixed case" do
		let(:mixed_case_email) { "LukahZero@gmail.com" }
